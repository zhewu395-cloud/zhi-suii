  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "text-[oklch(0.28_0.04_145)] hover:bg-[oklch(0.92_0.045_145_/_0.55)]",
        // 当天：偏绿一点的深绿
        "data-[today=true]:bg-[oklch(0.38_0.085_145)] data-[today=true]:text-[oklch(0.97_0.020_145)] data-[today=true]:font-medium data-[today=true]:rounded-[11px]",
        // 选中（筛选）：凝实的淡绿，与当天协调
        "data-[selected-single=true]:bg-[oklch(0.90_0.055_145)] data-[selected-single=true]:text-[oklch(0.28_0.06_145)] data-[selected-single=true]:rounded-[11px]",
        // range
        "data-[range-middle=true]:bg-[oklch(0.88_0.050_145)] data-[range-middle=true]:text-[oklch(0.25_0.06_145)]",
        "data-[range-start=true]:bg-[oklch(0.82_0.060_145)] data-[range-start=true]:text-[oklch(0.22_0.06_145)] data-[range-start=true]:rounded-l-[11px]",
        "data-[range-end=true]:bg-[oklch(0.82_0.060_145)] data-[range-end=true]:text-[oklch(0.22_0.06_145)] data-[range-end=true]:rounded-r-[11px]",
