...
// 与背景叶子一模一样的绿色系（同色相 145，不同明度/饱和）
const GREENS = [
  "oklch(0.34 0.045 145)",
  "oklch(0.42 0.055 145)",
  "oklch(0.52 0.060 145)",
  "oklch(0.62 0.055 145)",
  "oklch(0.72 0.060 145)",
  "oklch(0.80 0.055 145)",
  "oklch(0.86 0.045 145)",
];

// 微光点缀也统一为同色绿,仅明度更高
const SPARKS = [
  "oklch(0.92 0.050 145)",
  "oklch(0.88 0.060 145)",
  "oklch(0.85 0.055 145)",
  "oklch(0.90 0.045 145)",
  "oklch(0.95 0.040 145)",
];
